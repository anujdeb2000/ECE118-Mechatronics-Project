...
#define EVENT_CHECK_LIST CheckCenterTape, CheckTopTape, CheckRightTape, CheckLeftTape, CheckLeftObstacle, CheckRightObstacle, CheckBeacon
...
#define NINETY_TIMER 1
#define CORNER_TIMER 2   
#define OBSTACLE_TIMER 3
#define ISZ_TIMER 4
#define TAPE_WAIT_TIMER 5
#define LMAO_TIMER 6
