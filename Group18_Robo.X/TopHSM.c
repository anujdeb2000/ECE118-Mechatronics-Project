...
#include "BOARD.h"
#include "TopHSM.h"
#include "NavigationSubHSM.h" //#include all sub state machines called
...
ES_Event RunTemplateHSM(ES_Event ThisEvent)
{
    ...
    case NavigationState:                                                       //NAVIGATION STATE
        ...
        case ES_TIMEOUT:   
            ...
            if(ThisEvent.EventParam == CORNER_TIMER){ 
                InitEdgeRunnerSubHSM();
                nextState = TEdgeRunnerState;
                makeTransition = TRUE;
                ThisEvent.EventType = ES_NO_EVENT;
            }
...
//                break;
    ...
    case TEdgeRunnerState:                                                       //EDGE RUNNER STATE
        ThisEvent = RunEdgeRunnerSubHSM(ThisEvent);
...
//            break;         
    ...
    case TObstacleState:                                                           //OBSTACLE STATE
        ThisEvent = RunObstacleSubHSM(ThisEvent);
      switch (ThisEvent.EventType) {          
       case ES_TIMEOUT:   
            
            if(ThisEvent.EventParam == OBSTACLE_TIMER){ 
                InitBEdgeRunnerSubHSM();
                nextState = BEdgeRunnerState;
                makeTransition = TRUE;
                ThisEvent.EventType = ES_NO_EVENT;
            }
            
            else if(ThisEvent.EventParam == ISZ_TIMER){ 
                InitISZSubHSM();
                nextState = ISZState;
                makeTransition = TRUE;
                ThisEvent.EventType = ES_NO_EVENT;
    ...
    case BObstacleState:                                                           //OBSTACLE STATE
      ThisEvent = RunBotObstacleSubHSM(ThisEvent);
      switch (ThisEvent.EventType) {
    ...
    case BEdgeRunnerState:                                                           //OBSTACLE STATE
        ThisEvent = RunBEdgeRunnerSubHSM(ThisEvent);
      switch (ThisEvent.EventType) {
       ...
       case RIGHT_OBSTACLE_ON:   
                InitBotObstacleSubHSM();
                nextState = BObstacleState;
                makeTransition = TRUE;
                ThisEvent.EventType = ES_NO_EVENT;
            break;
...
//            break;     
    ...
    case ISZState:                                                               //ISZ STATE
      
      ThisEvent = RunISZSubHSM(ThisEvent);
      switch (ThisEvent.EventType) {
